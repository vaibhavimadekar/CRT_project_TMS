...
public class UserController {
    ...
    public String login(Model model, String logout) {
        ...
        HttpSession servletReqAttributes =
        ...
        if (logout != null) {
            ...
            Object login_error =
                    servletReqAttributes.getAttribute("login_error");

            if (login_error != null
                    && !((String) login_error).isEmpty()) {
                ...
                login_error =
                        servletReqAttributes.getAttribute(
                                "SPRING_SECURITY_LAST_EXCEPTION");

                if (login_error != null
                        && login_error instanceof BadCredentialsException) {

                    model.addAttribute(
                            "bad_credential",
                            ((BadCredentialsException) login_error)
                                    .getMessage());

                    servletReqAttributes.removeAttribute(
                            "SPRING_SECURITY_LAST_EXCEPTION");
                }
            }
        }
